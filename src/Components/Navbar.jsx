...
//           <p>COLLECTION</p>
//           <hr className='w-2/4 border-none h-[1.5px] bg-[#6f4e37] hidden' />
...
//               <p className='cursor-pointer hover:text-black'>My-Porofile</p>
...
//       {/* Sidebar Menu (Mobile) */}
//       <div className={`fixed top-0 right-0 h-full bg-white transition-all duration-300 z-50 shadow-lg ${visible ? 'w-3/4' : 'w-0'}`}>
...
const Navbar = () => {
  ...
  return (
    <div className=" rounded-sm sticky top-0 z-50 bg-white/0 shadow-[0_4px_6px_rgba(0,0,0,0.15)]">
      <div className='flex items-center justify-between p-2 font-medium rounded-sm'> 
